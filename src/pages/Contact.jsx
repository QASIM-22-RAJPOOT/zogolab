            ...
            <div className="space-y-6">
              <div className="flex items-center gap-5 rounded-xl bg-[#141414] p-7">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="mt-1 block text-base font-bold text-white hover:text-[#2d8cff]"
                  >
                    {COMPANY_EMAIL}
                  </a>
                </div>
              ...
              <div className="flex items-center gap-5 rounded-xl bg-[#141414] p-7">
                ...
                <div>
                  ...
                  <a
                    href="tel:+923716519006"
                    className="mt-1 block text-base font-bold text-white hover:text-[#8b5cff]"
                  >
                    +92 371 6519006
                  </a>
                </div>
